            ...
            if file == "main.tf":
                ...
                with open(file_path, 'r+', encoding='utf-8') as f:
                    ...
                    if code_to_remove in original_content:
                        ...
                        modified_content = original_content.replace(code_to_remove, '').strip()
...
print(f"Checked and updated all main.tf files within the {project_directory_path} directories.")
